...
var author$project$Api$getPokemons = A2(elm$http$Http$get, 'https://pokeapi.co/api/v2/pokemon/?limit=104', author$project$Api$listPokeMiniDecoder);
...
var author$project$Init$initialModel = {debounce: jinjor$elm_debounce$Debounce$init, evolution: krisajenkins$remotedata$RemoteData$NotAsked, fullPokemon: krisajenkins$remotedata$RemoteData$NotAsked, imageErrors: elm$core$Set$empty, pokemons: krisajenkins$remotedata$RemoteData$NotAsked, searchText: '', selectedPokemonIndex: -1};
...
var author$project$Update$SearchInputDebounced = function (a) {
	return {$: 'SearchInputDebounced', a: a};
};
...
var author$project$Update$debounceConfig = {
	strategy: jinjor$elm_debounce$Debounce$later(500),
	transform: author$project$Update$SearchInputDebounced
};
...
var author$project$Update$emitSearchInputChanged = function (text) {
	return A2(
		elm$core$Task$perform,
		author$project$Update$SearchInputChanged,
		elm$core$Task$succeed(text));
};
...
var author$project$Model$Pokemon = F8(
	function (name, order, height, weight, pokeType1, pokeType2, image, specieUrl) {
		return {height: height, image: image, name: name, order: order, pokeType1: pokeType1, pokeType2: pokeType2, specieUrl: specieUrl, weight: weight};
	});
...
var author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SearchInputTyped':
				var text = msg.a;
				var _n1 = A3(jinjor$elm_debounce$Debounce$push, author$project$Update$debounceConfig, text, model.debounce);
				var debounce = _n1.a;
				var cmd = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{debounce: debounce}),
					cmd);
			case 'SearchInputDebounced':
				var msg_ = msg.a;
				var _n2 = A4(
					jinjor$elm_debounce$Debounce$update,
					author$project$Update$debounceConfig,
					jinjor$elm_debounce$Debounce$takeLast(author$project$Update$emitSearchInputChanged),
					msg_,
					model.debounce);
				var debounce = _n2.a;
				var cmd = _n2.b;
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								fullPokemon: krisajenkins$remotedata$RemoteData$Success(fullPokemon)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								fullPokemon: krisajenkins$remotedata$RemoteData$Failure(error)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'SearchPokemons':
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								pokemons: krisajenkins$remotedata$RemoteData$Failure(error)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'ImageError':
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{fullPokemon: krisajenkins$remotedata$RemoteData$Loading, selectedPokemonIndex: index}),
					author$project$Update$getFullPokemon(name));
		}
	});
var author$project$Update$PokemonClicked = F2(
	function (a, b) {
		return {$: 'PokemonClicked', a: a, b: b};
	});
...
var author$project$View$pokeView = F2(
	function (fullPokemon, colorAttributes) {
		var cardClasses = A2(
			...
			' ',
			_List_fromArray(
				['pokeView', colorAttributes.color, colorAttributes.border, 'border-solid', 'border-2', 'rounded-lg', 'absolute', 'shadow-lg', 'p-4', 'flex', 'flex-col', 'justify-between', 'bg-white', 'z-10', 'w-64']));
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('flex justify-center font-thin text-sm mb-2')
								]),
							_List_fromArray(
								[
									A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('font-light text-justify')
								]),
							_List_fromArray(
								[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Attributes$class('pokeImage')
				]),
			_List_Nil);
	});
var author$project$View$viewLoading = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('ball-beat flex justify-center absolute w-full')
		]),
	_List_fromArray(
		[
...
var author$project$View$pokemonMiniView = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('pokeMini flex items-center justify-center flex-col cursor-pointer hover:shadow-lg rounded-full'),
							elm$html$Html$Events$onClick(
							A2(author$project$Update$PokemonClicked, index, pokemon.name))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							var _n0 = _Utils_Tuple2(
								model.fullPokemon,
								_Utils_eq(model.selectedPokemonIndex, index));
							_n0$2:
							while (true) {
								if (_n0.b) {
									switch (_n0.a.$) {
										case 'Success':
											var fullPokemon = _n0.a.a;
											return A2(
...
var author$project$View$pokedex = function (model) {
	...
	switch (filteredPokemons.$) {
		...
		case 'Loading':
			return author$project$View$viewLoading;
		case 'Failure':
			return author$project$View$viewFailure;
		default:
			return A2(elm$html$Html$div, _List_Nil, _List_Nil);
	}
};
var author$project$Update$SearchInputTyped = function (a) {
	return {$: 'SearchInputTyped', a: a};
};
...
var author$project$View$searchInput = function (searchText) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('flex justify-center mx-auto mt-4 px-4')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onInput(author$project$Update$SearchInputTyped),
	...
	var pokeName = A2(
		...
		A2(
			...
			A2(
				...
				elm$core$Basics$append('Pokemon | ')),
			A2(
				krisajenkins$remotedata$RemoteData$map,
				function ($) {
					return $.pokemon;
